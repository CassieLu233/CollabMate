...
const GitLabDialog = ({ open, onClose,user,onSelect}) => {
  ...
  //get all projects of the connected GitLab account
  const getProjects=async () => {
    try {
      const res = await fetch(`${API_BASE}/gitlab/projects`, {
      method: "GET",
      headers: {
  ...
  const getOneIssue = async () => {
    try {
      const res = await fetch(`${API_BASE}/gitlab/projects/${selectedProjectId}/issues/ids`, {
      method: "GET",
      headers: {
        'Authorization': `Bearer ${token}`,
      },
  ...
  // call the backend to convert the selected GitLab issue into a task
  const importIssue = async (projectId,issueIid) => {
    try {
      const res = await fetch(`${API_BASE}/gitlab/projects/${projectId}/issues/${issueIid}`, {
      method: "GET",
      headers: {
        'Authorization': `Bearer ${token}`,
      },
